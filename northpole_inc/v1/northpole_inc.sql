...
--
-- Host: localhost:3306
-- Generation Time: Dec 16, 2025 at 08:47 AM
...
CREATE TABLE `deeds` (
  ...
  `deed` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `gifts` (
  ...
  `brand` text NOT NULL,
  `about` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicorn_ci;
...
--
ALTER TABLE `deeds`
  MODIFY `deed_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `do`
--
ALTER TABLE `do`
  MODIFY `do_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `gifts`
--
ALTER TABLE `gifts`
  MODIFY `gift_id` int NOT NULL AUTO_INCREMENT;
